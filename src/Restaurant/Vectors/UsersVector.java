...
public final class UsersVector extends MyVector<Users>{
    ...
    // In UsersVector.java
    // FILEPATH: C:/Users/FADEL/Downloads/Restaurant-Reservation-System-master/Restaurant-Reservation-System-master/src/Restaurant/Vectors/UsersVector.java

    public Users searchByUsername(String username) {
        for (int i = 0; i < count; i++) {
            Users user = (Users) arr[i];
